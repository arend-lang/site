...
The exact value of *C*<sub>*ij*</sub> is now computed from *P*<sub>*i*</sub> and *z*<sub>*j*</sub> according to the set of rules described below.
...
1. **Strip off applications from** *z*<sub>*j*</sub> **expression until it becomes a plain constructor call**
   ...
   Starting from *e*<sub>*0*</sub> := *z*<sub>*j*</sub>, the algorithm performs the following simplifications:
...
This criterion is only tried if the strongly connected component in the call graph consists of only one vertex, i.e. one deals with a recursive function and not with mutual recursion.
...
2. Restrict attention to calls with indices in *I*<sub>*1*</sub>. For each *j* ∊ *I*<sub>*1*</sub>, 
   ...
   - Let *I*<sub>*2*</sub> be those *j* from *I*<sub>*1*</sub> for which *c*<sup>*j*</sup><sub>i<sub>2</sub>, i<sub>2</sub></sub> = “**=**”.
...
Otherwise, it will try to compute the completion of the call graph and will try to check if Termination Criterion 2 holds.
...
Intuition behind this sufficient condition is the following.
